...
settings_util.rebalance_pipes = settings.startup["kt-rebalance-pipes"].value
...
--bzgold
settings_util.gold = {}
settings_util.gold.gold_byproduct = settings_util.modify_gold and settings.startup["bzgold-byproduct"] and settings.startup["bzgold-byproduct"].value
...
settings_util.gold.rebalance_silver = settings_util.modify_gold and settings_util.gold.silver_processing and settings.startup["kt-rebalance-silver"] and settings.startup["kt-rebalance-silver"].value

--bzlead
settings_util.lead = {}
settings_util.lead.lead_byproduct = settings_util.modify_lead and settings.startup["bzlead-byproduct"] and settings.startup["bzlead-byproduct"].value
